...
[![Get it on Google Play](images/download-google-play.svg)](https://play.google.com/store/apps/details?id=com.eist.radio)
...
(function() {
  ...
  if (/android/i.test(userAgent)) {
    window.location.href = 'https://play.google.com/store/apps/details?id=com.eist.radio';
    return;
  }
